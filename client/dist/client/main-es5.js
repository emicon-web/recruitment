...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAddCandidateAddCandidateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AddCandidateComponent = /*#__PURE__*/function () {
      function AddCandidateComponent(fb, router, ngZone, notificationService, candidateService, userService) {
      ...
      _createClass(AddCandidateComponent, [{
        ...
        value: function mainForm() {
          ...
          this.candidateForm = this.fb.group({
            consultantImage: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
        ...
        value: function onSubmit() {
          ...
          if (k > 12) {
            ...
            if (!this.candidateForm.valid) {
              ...
              this.candidateService.addCandidate(this.candidateForm.get('consultantImage').value, this.candidateForm.value.consultantName, this.candidateForm.value.email, this.candidateForm.value.location, this.candidateForm.value.preferredLocation, this.candidateForm.value.phoneNumber, this.candidateForm.value.panNumber, this.candidateForm.value.adharNumber, this.candidateForm.value.skillSet, this.candidateForm.value.yearOfExperience, this.candidateForm.value.createdBy, this.candidateForm.get('resume').value).subscribe(function (res) {
                _this.notificationService.showSuccess('Candidate successfully created!', "");

                _this.ngZone.run(function () {
                  return _this.router.navigateByUrl('/candidates');
                });
              }, function (error) {
                console.log(error);

                _this.notificationService.showError(error, '');
              });
            }
          }
        }
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _guards_signup_guard__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./guards/signup.guard */
      ...
      _createClass(CandidateListComponent, [{
        ...
        value: function getCandidates() {
          ...
          this.candidateService.getCandidates().subscribe(function (data) {
            // this.spinner.hide();
            _this2.candidates = data.candidates;

            for (var i = 0; i < _this2.candidates.length; i++) {
              console.log(_this2.candidates[i]);
            }
      ...
      _createClass(EditCandidateComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.editForm = this.fb.group({
            ...
            panNumber: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].pattern('^[0-9]+$')]],
            ...
            if (!this.editForm.valid) {
              ...
              if (window.confirm('Are you sure?')) {
                ...
                this.candidateService.updateCandidate(id, this.editForm.value).subscribe(function (res) {
                  _this4.notificationService.showSuccess('Candidate updated successfully!', "");

                  _this4.router.navigateByUrl('/candidates');
                }, function (error) {
                  _this4.notificationService.showError(error.msg, '');
                });
              }
            }
          }
      ...
      _createClass(LoginComponent, [{
        ...
        value: function loginUser() {
          ...
          this.userService.userLogin(this.loginForm.value).subscribe(function (data) {
            _this5.notifyService.showSuccess('Login Successfully', "");

            localStorage.setItem('Token', data.token);

            _this5.router.navigate(["/candidates"]);
          }, function (err) {
            if (err.error.error) {
              _this5.notifyService.showError(err.error.error, "");
            } else if (err.error.msg) {
              _this5.notifyService.showError(err.error.msg, "");
            } else {
              _this5.notifyService.showError("Something went wrong", "");
            }
          });
        }
      }, {
  ...
  function srcAppServicesCandidateServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CandidateService = /*#__PURE__*/function () {
      ...
      _createClass(CandidateService, [{
        key: "addCandidate",
        value: function addCandidate(consultantImage, consultantName, email, location, preferredLocation, phoneNumber, panNumber, adharNumber, skillSet, yearOfExperience, createdBy, resume) {
          ...
          return this.http.post("".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiBaseUrl, "/candidate/add-candidate"), formData);
        }
      }, {
        key: "getCandidates",
        value: function getCandidates() {
      ...
      _createClass(SignupComponent, [{
        ...
        value: function getAllUsers() {
          ...
          this.userService.allUsers().subscribe(function (data) {
            _this6.allUsers = data.users;
          }, function (err) {
            _this6.notifyService.showError('Something Went Wrong', '');
          });
        }
      }, {
        key: "togglePassword",
        ...
        value: function submitForm() {
          ...
          this.userService.userSignup(this.signupForm.value).subscribe(function (data) {
            _this7.notifyService.showSuccess('Employee Account Created Successfully', "");

            _this7.router.navigate(["/"]);
          }, function (err) {
            if (err.error.error) {
              _this7.notifyService.showError(err.error.error, "");
            } else if (err.error.msg) {
              _this7.notifyService.showError(err.error.msg, "");
            } else {
              _this7.notifyService.showError("Something went wrong", "");
            }
          });
        }
      }, {
