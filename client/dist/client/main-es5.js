          ...
          if (k > 12) {
            ...
            if (!this.candidateForm.valid) {
              ...
              // this.candidateForm.get('resume').value
                ...
                if (err.error.error) {
                  _this2.notificationService.showError(err.error.error, "");
                } else if (err.error.msg) {
                  _this2.notificationService.showError(err.error.msg, "");
                } else {
                  _this2.notificationService.showError("Something went wrong", "");
                }
              });
            }
          }
        ...
        value: function onSubmit() {
          ...
          if (!this.instituteForm.valid) {
            ...
            this.instituteService.addInstitute(this.instituteForm.value).subscribe(function (res) {
              ...
              if (err.error.error) {
                _this6.notificationService.showError(err.error.error, "");
              } else if (err.error.msg) {
                _this6.notificationService.showError(err.error.msg, "");
              } else {
                _this6.notificationService.showError("Something went wrong", "");
              }
            });
          }
        }
